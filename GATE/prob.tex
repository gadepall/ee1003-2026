...
\end{cases}
\end{align*}
then, the percentage probability $P\left( -\frac{1}{3} \leq x \leq \frac{1}{3} \right)$ is: \hfill (CE 2008)
\begin{enumerate}
\begin{multicols}{2}
\item $0.247$
\item $2.47$
...
\includegraphics[width=0.5\columnwidth]{figs/2008/EC/q24a.png}
\caption{}
\label{fig:q24a}
\end{figure}
...
\hfill (EC 2008)
\begin{figure}[H]\centering
\includegraphics[width=0.95\columnwidth]{figs/2008/EC/q24b.png}
\caption{}
\label{fig:q24b}
\end{figure}
...
The value of $E\brak{X^3}$ will be %\{ ... \} produces curly braces {}
\hfill (EE 2008)
\begin{enumerate}
\begin{multicols}{4}
    \item 0
...
value of its cumulative distribution function at the origin will be \hfill{(IN 2008)}
\begin{multicols}{4}
    \begin{enumerate} 
        \item 0
        \item 0.5
    ...
    \item  A random variable is uniformly distributed over the interval 2 to 10. Its variance will be \hfill{(IN 2008)}
    \begin{multicols}{4}
    \begin{enumerate} 
        \item \(\frac{16}{3}\) 
        \item 6
